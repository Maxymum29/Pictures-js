...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextInput__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]'); // showMoreStyles(".button-styles", ".styles-2");
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Пожaлуйста выберите размер и материал картины';
...
var forms = function forms() {
  ...
  var message = {
    loading: "Загрузка",
    success: "Cпасибо! Скоро с вами свяжутся",
